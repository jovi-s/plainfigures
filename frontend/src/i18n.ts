...
const resources = {
  en: {
    translation: {
      ...
      "add_data.subtitle": "Simply snap a picture or upload documents - we'll handle the rest",
      "add_data.upload_title": "Upload Document",
      "add_data.upload_description": "Photo or PDF",
      ...
      "add_data.extracted_data_title": "Extracted Data",
      "add_data.extracted_data_description": "Review and verify the extracted information",
      "add_data.image_preview_title": "Image Preview",
      "add_data.image_preview_description": "Visual preview of the uploaded document",
      "add_data.pdf_preview_title": "PDF Preview",
      "add_data.pdf_preview_description": "Document preview of the uploaded PDF",
      "add_data.open_pdf_new_tab": "Open PDF in new tab",
      "add_data.vendor": "Vendor",
      "add_data.amount": "Amount",
      "add_data.issue_date": "Issue Date",
      "add_data.due_date": "Due Date",
      "add_data.subtotal": "Subtotal",
      "add_data.tax": "Tax",
      "add_data.line_items": "Line Items",
      "add_data.raw_text": "Raw Text",
      "add_data.no_data_extracted": "No data extracted yet",
      "add_data.upload_file_to_see_data": "Upload a file to see extracted data here",
      "add_data.save_to_db": "Add to Database",
      "add_data.saving": "Saving...",
      "add_data.saved": "Saved",
  ...
  id: {
    translation: {
      ...
      "add_data.upload_description": "Foto atau PDF",
      ...
      "add_data.extracted_data_title": "Data yang Diekstrak",
      "add_data.extracted_data_description": "Tinjau dan verifikasi informasi yang diekstrak",
      "add_data.image_preview_title": "Pratinjau Gambar",
      "add_data.image_preview_description": "Pratinjau visual dari dokumen yang diunggah",
      "add_data.pdf_preview_title": "Pratinjau PDF",
      "add_data.pdf_preview_description": "Pratinjau dokumen dari PDF yang diunggah",
      "add_data.open_pdf_new_tab": "Buka PDF di tab baru",
      "add_data.vendor": "Vendor",
      "add_data.amount": "Jumlah",
      "add_data.issue_date": "Tanggal Terbit",
      "add_data.due_date": "Tanggal Jatuh Tempo",
      "add_data.subtotal": "Subtotal",
      "add_data.tax": "Pajak",
      "add_data.line_items": "Item Baris",
      "add_data.raw_text": "Teks Mentah",
      "add_data.no_data_extracted": "Belum ada data yang diekstrak",
      "add_data.upload_file_to_see_data": "Unggah file untuk melihat data yang diekstrak di sini",
      "add_data.save_to_db": "Tambah ke Database",
      "add_data.saving": "Menyimpan...",
      "add_data.saved": "Tersimpan",
  ...
  th: {
    translation: {
      ...
      "add_data.upload_description": "รูปภาพ หรือ PDF",
      ...
      "add_data.extracted_data_title": "ข้อมูลที่สกัดได้",
      "add_data.extracted_data_description": "ตรวจสอบและยืนยันข้อมูลที่สกัดได้",
      "add_data.image_preview_title": "ตัวอย่างภาพ",
      "add_data.image_preview_description": "ตัวอย่างภาพของเอกสารที่อัปโหลด",
      "add_data.pdf_preview_title": "ตัวอย่าง PDF",
      "add_data.pdf_preview_description": "ตัวอย่างเอกสารของ PDF ที่อัปโหลด",
      "add_data.open_pdf_new_tab": "เปิด PDF ในแท็บใหม่",
      "add_data.vendor": "ผู้ขาย",
      "add_data.amount": "จำนวน",
      "add_data.issue_date": "วันที่ออก",
      "add_data.due_date": "วันครบกำหนด",
      "add_data.subtotal": "ยอดย่อย",
      "add_data.tax": "ภาษี",
      "add_data.line_items": "รายการสินค้า",
      "add_data.raw_text": "ข้อความดิบ",
      "add_data.no_data_extracted": "ยังไม่มีข้อมูลที่สกัดได้",
      "add_data.upload_file_to_see_data": "อัปโหลดไฟล์เพื่อดูข้อมูลที่สกัดได้ที่นี่",
      "add_data.save_to_db": "เพิ่มไปยังฐานข้อมูล",
      "add_data.saving": "กำลังบันทึก...",
      "add_data.saved": "บันทึกแล้ว",
  ...
  tl: {
    translation: {
      ...
      "add_data.extracted_data_title": "Nakuhang Data",
      "add_data.extracted_data_description": "Suriin at i-verify ang nakuhang impormasyon",
      "add_data.image_preview_title": "Preview ng Larawan",
      "add_data.image_preview_description": "Visual na preview ng na-upload na dokumento",
      "add_data.pdf_preview_title": "Preview ng PDF",
      "add_data.pdf_preview_description": "Dokumento preview ng na-upload na PDF",
      "add_data.open_pdf_new_tab": "Buksan ang PDF sa bagong tab",
      "add_data.vendor": "Vendor",
      "add_data.amount": "Halaga",
      "add_data.issue_date": "Petsa ng Paglabas",
      "add_data.due_date": "Due Date",
      "add_data.subtotal": "Subtotal",
      "add_data.tax": "Buwis",
      "add_data.line_items": "Mga Line Item",
      "add_data.raw_text": "Raw Text",
      "add_data.no_data_extracted": "Wala pang nakuhang data",
      "add_data.upload_file_to_see_data": "Mag-upload ng file para makita ang nakuhang data dito",
      "add_data.save_to_db": "Idagdag sa Database",
      "add_data.saving": "Nag-se-save...",
      "add_data.saved": "Na-save na",
